...
public class CreativeInv extends GuiContainer
{
    ...
    public CreativeInv(EntityPlayer p_i1088_1_)
    {
        super(new CreativeInv.ContainerCreative(p_i1088_1_));
        //new ContainerWorkbench(Minecraft.getMinecraft().thePlayer.inventory, Minecraft.getMinecraft().theWorld, -280,4,666);
    ...
    public void initGui()
    {
        ...
        this.searchField = new GuiTextField(this.fontRendererObj, this.guiLeft + 82 + 100, this.guiTop + 6, 89, this.fontRendererObj.FONT_HEIGHT);
    ...
    {
    	CreativeInv.ContainerCreative containercreative = (CreativeInv.ContainerCreative)this.inventorySlots;
    ...
    private boolean needsScrollBars()
    {
        ...
        return selectedTabIndex != CreativeTabs.tabInventory.getTabIndex() && CreativeTabs.creativeTabArray[selectedTabIndex].shouldHidePlayerInventory() && ((CreativeInv.ContainerCreative)this.inventorySlots).func_148328_e();
    }
    ...
    private void setCurrentCreativeTab(CreativeTabs p_147050_1_)
    {
        ...
        if (p_147050_1_ == CreativeTabs.tabInventory)
        {
            ...
            {
            	CreativeInv.CreativeSlot creativeslot = new CreativeInv.CreativeSlot((Slot)container.inventorySlots.get(j), j);
    ...
    static class ContainerCreative extends Container
        {
            ...
            public ContainerCreative(EntityPlayer p_i1086_1_)
            {
                ...
                for (i = 0; i < 5; ++i)
                {
                    for (int j = 0; j < 9; ++j)
                    {
                        this.addSlotToContainer(new Slot(CreativeInv.field_147060_v, i * 9 + j, 9 + j * 18, 18 + i * 18));
                    }
                }
                
                
                // Crafting
                this.addSlotToContainer(new Slot(CreativeInv.craftResult, 0, -200 + 124, 35));
                int l;
                int i1;
                ...
                for (l = 0; l < 3; ++l)
                {
                    for (i1 = 0; i1 < 3; ++i1)
                    {
                        this.addSlotToContainer(new Slot(CreativeInv.recipefield, i1 + l * 3,-200 + 30 + i1 * 18, 17 + l * 18));
                    }
                }
                // Crafting
            ...
            public void scrollTo(float p_148329_1_)
            {
                ...
                for (int k = 0; k < 5; ++k)
                {
                    for (int l = 0; l < 9; ++l)
                    {
                        ...
                        {
                        	CreativeInv.field_147060_v.setInventorySlotContents(l + k * 9, (ItemStack)this.itemList.get(i1));
                        }
                        else
                        {
                        	CreativeInv.field_147060_v.setInventorySlotContents(l + k * 9, (ItemStack)null);
                        }
                    }
                }
            }
