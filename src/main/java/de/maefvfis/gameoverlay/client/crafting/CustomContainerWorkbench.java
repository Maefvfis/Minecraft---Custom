...
public class CustomContainerWorkbench extends Container
{
    ...
    public CustomInventoryCrafting craftMatrix = new CustomInventoryCrafting(this, 3, 3);
    ...
    public CustomContainerWorkbench(InventoryPlayer p_i1808_1_, World p_i1808_2_, int p_i1808_3_, int p_i1808_4_, int p_i1808_5_)
    {
    ...
    {
        this.craftResult.setInventorySlotContents(0, CustomCraftingManager.getInstance().findMatchingRecipe(this.craftMatrix, this.worldObj));
    }
